...
export default function ThirdC() {
  return (
    <div className='text-right '>
          ...
          <div className="rounded-[5px] flex  mt-8 ml-auto items-center bg-white w-fit lg:w-11/12">
            <HiOutlineArrowSmLeft className=' bg-primary_1 size-12 mr-4 p-2 rounded-l-[5px]'/>
            <input
              type="email"
              className="focus:outline-none text-gray-500 rounded-[5px] text-right p-2 w-full "
